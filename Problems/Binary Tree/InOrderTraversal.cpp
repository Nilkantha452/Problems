/* Do an inorder traversal in a binary tree. */
...
/* Recursive way to do inorder traversal. */
...
std::vector<int> inorderTraversalEx(TreeNode* root)
{
...
int main()
{
    ...
    std::cout << std::endl;
    std::vector<int> ans = inorderTraversalEx(root);
